...
from tests.variables import empty_folder, table_pdf_file, table_png_file_standard, test_images_dir, \
    test_xmls_structures_dir, test_table_images_dir
from tests.setup_testenv import before_and_after, setup_test_environment

# TODO: test PyPDF2Textport

'''
def test_PyPDF2Textport_dataobjVariablesShouldBePersistent(setup_test_environment, before_and_after):
    # Arrange
    ...
    input_dataobj = DataObj(input_file=table_pdf_file,
                            ...
                            data=data)
    # Act
    output_dataobj = extractable.PyPDF2Textport.process(input_dataobj)
...
def test_PyPDF2Textport_shouldCreateOutputXMLsWithTextToOutputfile(before_and_after):
    # Arrange
    mock_tempobj = tempfile.TemporaryDirectory()
    mock_tempdir = mock_tempobj.name
